    ...
    <section className="py-20 md:py-32 px-6">
      <div ref={ref} className="max-w-7xl mx-auto">
        ...
        >
          <a
            href="#contacto"
            className="inline-flex bg-primary text-primary-foreground px-10 py-4 rounded-full text-base font-semibold hover:bg-primary/90 transition-all duration-300 hover:scale-105"
          >
            Quiero empezar
          </a>
        </motion.div>
